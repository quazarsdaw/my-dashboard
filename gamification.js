(function () {
  ...
  var ACHIEVEMENT_DEFS = [
    ...
    { id: 'tasks_50', rarity: 'rare', bonus: 50, name: '52', icon: '🏙️', desc: 'Да здравствует Санкт-Петербург (50 задач)' },
    ...
    { id: 'coins_1000', rarity: 'rare', bonus: 100, name: 'Темщик', icon: '💸', desc: 'Набери 1000 монет' },
    ...
    { id: 'early_bird_10', rarity: 'rare', bonus: 50, name: 'Овсянка, сэр!', icon: '🌄', desc: '10 задач ранним утром' },
    ...
    { id: 'days_30', rarity: 'epic', bonus: 300, name: 'Работяга', icon: '🗓️', desc: '30 активных дней' },
    ...
    { id: 'finance_master', rarity: 'epic', bonus: 200, name: 'Успешный успех', icon: '💹', desc: '15 уровень в Финансах' },
    ...
    { id: 'night_owl', rarity: 'epic', bonus: 100, name: 'Дединсайд', icon: '🦉', desc: 'Задача после 00:00' },
    { id: 'gym_50', rarity: 'epic', bonus: 400, name: 'Сигма', icon: '🗿', desc: '50 тренировок завершено' },
    { id: 'finance_balance_10000', rarity: 'epic', bonus: 300, name: 'Мамкин инвестор', icon: '📈', desc: 'Баланс финансов > 10000' },
    ...
    { id: 'big_spender', rarity: 'epic', bonus: 250, name: 'Мамонт', icon: '🦣', desc: 'Потрачено 5000 монет' },
    ...
    { id: 'tasks_1000', rarity: 'legendary', bonus: 2500, name: 'Чиназес', icon: '😎', desc: '1000 выполненных задач' },
    ...
    { id: 'gym_100', rarity: 'legendary', bonus: 1500, name: 'Гигачад', icon: '💪', desc: '100 тренировок' },
    { id: 'all_max_lvl', rarity: 'legendary', bonus: 2000, name: 'Сын маминой подруги', icon: '🥇', desc: '10 уровень во всех сферах' },
