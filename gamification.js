(function () {
  ...
  var ACHIEVEMENT_DEFS = [
    { id: 'first_task', rarity: 'common', bonus: 2, name: 'База', icon: '🌱', desc: 'Первый шаг сделан!', req: 'Выполни первую задачу' },
    { id: 'altushka', rarity: 'common', bonus: 5, name: 'Альтушка с госуслуг', icon: '👩‍🎤', desc: 'Главное — не перепутать с налогами.', req: 'Первая покупка в магазине' },
    { id: 'tasks_10', rarity: 'common', bonus: 8, name: 'Разогрев', icon: '🔥', desc: 'Маховик продуктивности запущен.', req: 'Выполни 10 задач' },
    { id: 'hours_1', rarity: 'common', bonus: 4, name: 'Час пользы', icon: '⏱️', desc: 'Время — деньги, а ты только что заработал.', req: '1 час в фокусе' },
    { id: 'days_3', rarity: 'common', bonus: 10, name: 'Стабильность', icon: '📅', desc: 'Три дня — это уже привычка (почти).', req: '3 активных дня' },
    { id: 'coins_50', rarity: 'common', bonus: 5, name: 'Мелочь', icon: '🪙', desc: 'Приятно звенит в кармане.', req: 'Заработай 50 монет' },
    { id: 'level_5', rarity: 'common', bonus: 15, name: 'Новичок+', icon: '🏅', desc: 'Уже не «зеленый», но еще не мастер.', req: 'Достигни 5 уровня' },
    { id: 'gym_1', rarity: 'common', bonus: 6, name: 'Спортсмен', icon: '💪', desc: 'Главное — дойти до зала.', req: 'Первая тренировка' },
    { id: 'sphere_xp', rarity: 'common', bonus: 3, name: 'Первый опыт', icon: '✨', desc: 'Прокачка началась!', req: 'Получи XP в любой сфере' },
    { id: 'early_bird', rarity: 'common', bonus: 5, name: 'Кто понял жизнь...', icon: '☀️', desc: '...тот не спешит, но всё успевает.', req: 'Задача до 9:00' },
    { id: 'number_67', rarity: 'common', bonus: 25, name: '67', icon: '🎰', desc: 'Красивое число. Рандом одобряет.', req: 'Выполни ровно 67 задач' },
    { id: 'clothing_78', rarity: 'common', bonus: 10, name: '7-8 одежда', icon: '👕', desc: 'Классика жанра. Ты в теме.', req: 'Выполни 8 задач за день' },

    { id: 'tasks_50', rarity: 'rare', bonus: 20, name: '52', icon: '🏙️', desc: 'Да-да, Санкт-Петербург! Привет Неве.', req: 'Выполни 50 задач' },
    { id: 'tasks_75', rarity: 'rare', bonus: 25, name: 'Специалист', icon: '🛠️', desc: 'Твои навыки растут не по дням.', req: '75 выполненных задач' },
    { id: 'temshik', rarity: 'rare', bonus: 30, name: 'Темщик', icon: '💸', desc: 'Мутишь схемы, копишь монетки.', req: 'Набери 1000 монет' },
    { id: 'surgut', rarity: 'rare', bonus: 25, name: 'Сургут', icon: '❄️', desc: 'Холодный расчет и железные мышцы.', req: '10 тренировок' },
    { id: 'technik', rarity: 'rare', bonus: 20, name: 'Техник', icon: '🎧', desc: 'Слушаешь только качественный контент.', req: 'Купи 10 наград' },
    { id: 'skuf', rarity: 'rare', bonus: 1, name: 'Скуф', icon: '🍺', desc: 'Диван манит, но ты держишься (или нет).', req: '30 дней без тренировок' },
    { id: 'hours_20', rarity: 'rare', bonus: 30, name: 'Сутки пользы', icon: '⏳', desc: 'Целый день чистого фокуса за плечами.', req: '24 часа в фокусе' },
    { id: 'hours_40', rarity: 'rare', bonus: 40, name: 'Трудоголик', icon: '👔', desc: 'Остановись, отдохни! Но нет, ты идешь дальше.', req: '40 часов в фокусе' },
    { id: 'days_7', rarity: 'rare', bonus: 25, name: 'Недельный стрик', icon: '📆', desc: 'Ни одного прогула. Мощно.', req: '7 активных дней подряд' },
    { id: 'days_14', rarity: 'rare', bonus: 35, name: 'Две недели', icon: '🌓', desc: 'Половина месяца в ритме.', req: '14 активных дней' },
    { id: 'coins_500', rarity: 'rare', bonus: 20, name: 'Состоятельный', icon: '💎', desc: 'Можешь позволить себе лишний десерт.', req: 'Заработай 500 монет' },
    { id: 'level_10', rarity: 'rare', bonus: 30, name: 'Десятка', icon: '🎖️', desc: 'Двузначное число — новый статус.', req: 'Достигни 10 уровня' },
    { id: 'level_15', rarity: 'rare', bonus: 40, name: 'Профи', icon: '🌟', desc: 'Тебя уже не остановить.', req: 'Достигни 15 уровня' },
    { id: 'gym_10', rarity: 'rare', bonus: 30, name: 'Атлет', icon: '🏃', desc: 'Тело говорит «спасибо» (и немного болит).', req: '10 тренировок' },
    { id: 'gym_streak', rarity: 'rare', bonus: 20, name: 'Режим', icon: '🔋', desc: 'Триатлон в крови.', req: '3 тренировки за неделю' },
    { id: 'all_spheres', rarity: 'rare', bonus: 25, name: 'Универсал', icon: '🌈', desc: 'Развиваешься во всех направлениях сразу.', req: 'XP во всех сферах' },
    { id: 'store_5', rarity: 'rare', bonus: 15, name: 'Шопоголик', icon: '🛍️', desc: 'Магазин — твой второй дом.', req: '5 покупок в магазине' },
    { id: 'health_5', rarity: 'rare', bonus: 20, name: 'ЗОЖник', icon: '🍎', desc: 'Яблоки вместо чипсов. Выбор сделан.', req: '5 уровень в Здоровье' },
    { id: 'finance_5', rarity: 'rare', bonus: 20, name: 'Экономист', icon: '📈', desc: 'Дебет с кредитом сходятся.', req: '5 уровень в Финансах' },
    { id: 'career_5', rarity: 'rare', bonus: 20, name: 'Карьерист', icon: '💼', desc: 'Лестница ведет только вверх.', req: '5 уровень в Карьере' },
    { id: 'night_owl_3', rarity: 'rare', bonus: 15, name: 'Полуночник', icon: '🌑', desc: 'В тишине работается лучше.', req: '3 задачи ночью' },
    { id: 'early_bird_10', rarity: 'rare', bonus: 20, name: 'Овсянка, сэр!', icon: '🌄', desc: 'Завтрак чемпиона — выполненные дела.', req: '10 задач ранним утром' },
    { id: 'gym_variety', rarity: 'rare', bonus: 25, name: 'Многоборец', icon: '🏟️', desc: 'Разные дни — разные нагрузки.', req: 'Тренировки в 5 днях' },
    { id: 'habit_7', rarity: 'rare', bonus: 20, name: 'Привычка', icon: '🔄', desc: 'Автопилот включен.', req: '7 активных дней' },

    { id: 'svo', rarity: 'epic', bonus: 80, name: 'С.В.О.', icon: '🎖️', desc: 'Сверх-Важные Операции. Только для элиты.', req: '5 сложных задач подряд' },
    { id: 'borov', rarity: 'epic', bonus: 120, name: 'Боров', icon: '🐗', desc: 'Накопил жирок... то есть капитал.', req: 'Накопи 5000 монет' },
    { id: 'mamont', rarity: 'epic', bonus: 60, name: 'Мамонт', icon: '🦣', desc: 'Тебя развели на покупки... или ты просто щедрый.', req: 'Потрачено 5000 монет' },
    { id: 'mamkin_investor', rarity: 'epic', bonus: 80, name: 'Мамкин инвестор', icon: '📈', desc: 'Купил биткоин по совету соседа.', req: 'Баланс финансов > 10000' },
    { id: 'dedinsight', rarity: 'epic', bonus: 40, name: 'Дединсайд', icon: '🦉', desc: 'Свет в окне в 3 часа ночи — это ты.', req: 'Задача после 00:00' },
    { id: 'sigma', rarity: 'epic', bonus: 100, name: 'Сигма', icon: '🗿', desc: 'Идешь своим путем, не смотря ни на что.', req: '50 тренировок' },
    { id: 'tasks_150', rarity: 'epic', bonus: 70, name: 'Машина', icon: '🤖', desc: 'Твой процессор не перегревается.', req: '150 выполненных задач' },
    { id: 'tasks_300', rarity: 'epic', bonus: 120, name: 'Неудержимый', icon: '🚀', desc: 'Скорость превышает все нормы.', req: '300 выполненных задач' },
    { id: 'hours_100', rarity: 'epic', bonus: 120, name: 'Мастер времени', icon: '🌓', desc: 'Ты управляешь временем, а не оно тобой.', req: '100 часов в фокусе' },
    { id: 'hours_150', rarity: 'epic', bonus: 180, name: 'Ветеран труда', icon: '🛠️', desc: 'Заслуженный отдых? Не, не слышал.', req: '150 часов продуктивности' },
    { id: 'days_30', rarity: 'epic', bonus: 100, name: 'Работяга', icon: '🗓️', desc: 'Месяц без перебоев. Гордись.', req: '30 активных дней' },
    { id: 'days_60', rarity: 'epic', bonus: 150, name: 'Железная воля', icon: '🛡️', desc: 'Твой дух крепче алмаза.', req: '60 активных дней' },
    { id: 'level_25', rarity: 'epic', bonus: 100, name: 'Четверть пути', icon: '👑', desc: 'Первый серьезный юбилей.', req: 'Достигни 25 уровня' },
    { id: 'level_40', rarity: 'epic', bonus: 150, name: 'Элита', icon: '💎', desc: 'Верхушка пищевой цепочки.', req: 'Достигни 40 уровня' },
    { id: 'gym_30', rarity: 'epic', bonus: 100, name: 'Бодибилдер', icon: '🏋️‍♂️', desc: 'Скоро в дверь не пролезешь.', req: '30 тренировок' },
    { id: 'gym_50', rarity: 'epic', bonus: 150, name: 'Геракл', icon: '🏺', desc: '12 подвигов — это только начало.', req: '50 тренировок завершено' },
    { id: 'finance_master', rarity: 'epic', bonus: 100, name: 'Успешный успех', icon: '💹', desc: 'Инфобизнесмены кусают локти.', req: '15 уровень в Финансах' },
    { id: 'career_master', rarity: 'epic', bonus: 100, name: 'Директор', icon: '🏢', desc: 'Твой кабинет на последнем этаже.', req: '15 уровень в Карьере' },
    { id: 'growth_master', rarity: 'epic', bonus: 100, name: 'Мудрец', icon: '🧙‍♂️', desc: 'Познал дзен и смысл бытия.', req: '15 уровень в Развитии' },
    { id: 'pomo_master', rarity: 'epic', bonus: 60, name: 'Помидорный маг', icon: '🍅', desc: 'Вырастил целый сад продуктивности.', req: 'Использовал таймер 50 раз' },
    { id: 'night_owl', rarity: 'epic', bonus: 40, name: 'Ночной дозор', icon: '🦉', desc: 'Город засыпает, просыпаешься ты.', req: 'Задача после 00:00' },
    { id: 'finance_balance_10000', rarity: 'epic', bonus: 80, name: 'Инвестор+', icon: '📈', desc: 'Портфель в плюсе, нервы в порядке.', req: 'Баланс финансов > 10000' },
    { id: 'task_spree_20', rarity: 'epic', bonus: 80, name: 'Марафонец', icon: '🏁', desc: 'Дыхание ровное, темп высокий.', req: '20 задач за всё время' },
    { id: 'all_spheres_5', rarity: 'epic', bonus: 120, name: 'Разносторонний', icon: '💠', desc: 'Человек эпохи Возрождения.', req: '5 уровень во всех сферах' },
    { id: 'big_spender', rarity: 'epic', bonus: 100, name: 'Магнат', icon: '🥂', desc: 'Деньги любят движение.', req: 'Потрачено 5000 монет' },
    { id: 'saver', rarity: 'epic', bonus: 80, name: 'Скряга', icon: '🔒', desc: 'Каждая копейка под замком.', req: 'Баланс монет > 2000' },

    { id: 'river_walker', rarity: 'legendary', bonus: 400, name: 'Идущий к реке', icon: '🌊', desc: 'Ты абсолютно спокоен и бесконечно вечен.', req: '500 часов чистого времени' },
    { id: 'gigachad', rarity: 'legendary', bonus: 350, name: 'Гигачад', icon: '💪', desc: 'Твой подбородок режет стекло.', req: '100 тренировок' },
    { id: 'moms_friend_son', rarity: 'legendary', bonus: 500, name: 'Сын маминой подруги', icon: '🥇', desc: 'Мифическое существо, о котором ходят легенды.', req: '10 уровень во всех сферах' },
    { id: 'chinazes', rarity: 'legendary', bonus: 600, name: 'Чиназес', icon: '😎', desc: 'Сюдаааа! Уровень комфорта зашкаливает.', req: '1000 выполненных задач' },
    { id: 'capitalist', rarity: 'legendary', bonus: 800, name: 'Капиталист', icon: '🏦', desc: 'У тебя есть свой монопольный завод.', req: 'Баланс финансов > 1 000 000' },
    { id: 'level_75', rarity: 'legendary', bonus: 600, name: 'Легенда', icon: '🔱', desc: 'Про тебя будут писать в учебниках.', req: 'Достигни 75 уровня' },
    { id: 'tasks_500', rarity: 'legendary', bonus: 300, name: 'Сверхчеловек', icon: '⚡', desc: 'Границы возможного стерты.', req: '500 выполненных задач' },
    { id: 'tasks_1000', rarity: 'legendary', bonus: 500, name: 'АБСОЛЮТ', icon: '🏛️', desc: 'Ты и есть сама эффективность.', req: '1000 выполненных задач' },
    { id: 'hours_500', rarity: 'legendary', bonus: 500, name: 'Повелитель времени', icon: '⏳', desc: 'Хронос твой лучший друг.', req: '500 часов в фокусе' },
    { id: 'days_100', rarity: 'legendary', bonus: 400, name: 'Стодневник', icon: '🏆', desc: '100 дней подряд. Без комментариев.', req: '100 активных дней' },
    { id: 'days_365', rarity: 'legendary', bonus: 1500, name: 'Год жизни', icon: '🌍', desc: 'Ты прожил год в режиме Бога.', req: '365 активных дней' },
    { id: 'coins_25000', rarity: 'legendary', bonus: 600, name: 'Золотой фонд', icon: '🏺', desc: 'Твой сейф лопается от золота.', req: 'Набери 25000 монет всего' },
    { id: 'gym_100', rarity: 'legendary', bonus: 400, name: 'Олимпиец', icon: '🥇', desc: 'Зевс гордится тобой.', req: '100 тренировок' },
    { id: 'all_max_lvl', rarity: 'legendary', bonus: 500, name: 'Магистр сфер', icon: '🔮', desc: 'Вселенная под твоим контролем.', req: '10 уровень во всех сферах' },
    { id: 'streak_30', rarity: 'legendary', bonus: 300, name: 'Несгораемый', icon: '🧨', desc: 'Никакие пожары не остановят твой стрик.', req: '30 активных дней' },
    { id: 'finance_balance_100000', rarity: 'legendary', bonus: 500, name: 'Капиталист JR', icon: '🏦', desc: 'Миллионы уже близко.', req: 'Баланс финансов > 100000' },
    { id: 'pomo_100', rarity: 'legendary', bonus: 250, name: 'Дзен', icon: '🧘', desc: 'Твой ум чист, как горный ручей.', req: '100 сессий таймера' },

    { id: 'tasks_5000', rarity: 'mythic', bonus: 2000, name: 'Творец миров', icon: '🌌', desc: 'Ты создал свою собственную реальность.', req: '5000 выполненных задач' },
    { id: 'hours_2000', rarity: 'mythic', bonus: 3000, name: 'Вне времени', icon: '🌀', desc: 'Твой след в истории останется навсегда.', req: '2000 часов продуктивности' },
    { id: 'level_100', rarity: 'mythic', bonus: 2500, name: 'БОЖЕСТВО', icon: '🪐', desc: 'Ты больше не человек. Ты — чистая энергия.', req: 'Достигни 100 уровня' },
    { id: 'billionaire', rarity: 'mythic', bonus: 5000, name: 'Властелин богатства', icon: '♾️', desc: 'Все деньги мира у твоих ног.', req: 'Заработай 100к монет всего' },
    { id: 'perfectionist', rarity: 'mythic', bonus: 2000, name: 'Перфекционист', icon: '💎', desc: 'Идеал достигнут. Дальше некуда.', req: 'Все сферы на 50 уровне' },
    { id: 'pomo_500', rarity: 'mythic', bonus: 1500, name: 'Абсолютный фокус', icon: '🧿', desc: 'Твоя концентрация способна двигать горы.', req: '500 сессий таймера' },
  ];
